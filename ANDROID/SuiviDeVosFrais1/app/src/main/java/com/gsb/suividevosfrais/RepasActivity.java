...
public class RepasActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Global.changeAfficheDate((DatePicker) findViewById(R.id.dateRepas)) ;
	...
	private void valoriseProprietes() {
		annee = ((DatePicker)findViewById(R.id.dateRepas)).getYear() ;
		mois = ((DatePicker)findViewById(R.id.dateRepas)).getMonth() + 1 ;
    ...
    private void dat_clic() {   	
    	final DatePicker uneDate = (DatePicker)findViewById(R.id.dateRepas) ;
